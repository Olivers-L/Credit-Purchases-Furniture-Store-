        ...
        case 1:
            ...
            while (1) {
                ...
                if (scanf("%lf", &income) != 1) {
                    printf("Error: income must be a number.\n");
                ...
                if (getchar() != '\n') {
                    printf("Error: enter only a number for income.\n");
            ...
            while (1) {
                ...
                if (getchar() != '\n') {
                    printf("Error: enter only a number for price.\n");
            ...
            while (1) {
                ...
                if (scanf("%d", &term) != 1) {
                    printf("Error: term must be a number.\n");
                ...
                if (getchar() != '\n') {
                    printf("Error: enter only a number for the term.\n");
            ...
            if (installment <= income * 0.30) {
                ...
                printf(
                    "Credit rejected: installment %.2f EUR exceeds 30%% of income (%.2f EUR).\n",
                    installment,
                    income * 0.30
                );
            }
